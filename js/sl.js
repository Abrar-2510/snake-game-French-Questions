...
var rolldice = function()
{
	...
	setTimeout(function()
	{
		...
		if(shah.currentpos == "debut") shah.currentpos = 1;
		if(shah.currentpos == "★") shah.currentpos = 100;
		shah.currentpos += randomNum;
		shah.lastrolled = randomNum;
		var tempholder;
		
		if(shah.currentpos == 0)		tempholder = "debut";
		else if(shah.currentpos >= 100)	tempholder = "★";
